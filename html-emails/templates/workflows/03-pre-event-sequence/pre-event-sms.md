# Pre-Event SMS Sequence

**Workflow:** 03-pre-event-sequence
**Audience:** All registrants (with VIP variants noted)
**T=0:** Day 1 start at 8:00 AM Pacific / 11:00 AM Eastern
...
Mark your calendar. {{custom_values.doe_event_dates}}. Your life is waiting.
```

**Offset:** -29d 23h
**Character Count:** ~320 (multi-segment)
...
**Offset:** -24d 23h
**Character Count:** ~300 (multi-segment)
...
Hold that thought. Carry it into {{custom_values.doe_day_1_date_short}}.
...
Day 1 ({{custom_values.doe_day_1_date_short}}): Begins {{custom_values.doe_day_1_start_time}}
Day 2 ({{custom_values.doe_day_2_date_short}}): Begins {{custom_values.doe_day_2_start_time}}
...
**Offset:** -8d 23h
**Character Count:** ~380 (multi-segment)
...
**Offset:** -6d 23h
**Character Count:** ~350 (multi-segment)
...
The greatest breakthroughs happen when your comfort zone is interrupted. Together, we'll move beyond the patterns that have been restricting your life.
...
**Offset:** -3d 23h
**Character Count:** ~400 (multi-segment)
...
VIP Elite upgrade closes {{custom_values.doe_day_1_date_short}} at {{custom_values.doe_vip_deadline_time}}. If you want personalized guidance, decide now.

Either way — see you {{custom_values.doe_day_1_date_short}}.
```

**Offset:** -2d 23h
**Audience:** Non-VIP only
**Character Count:** ~420 (multi-segment)
...
Zoom link arrives {{custom_values.doe_day_1_date_short}} morning.
...
**Offset:** -1d 23h
**Audience:** VIP only
**Character Count:** ~360 (multi-segment)
...
Day 1 begins at {{custom_values.doe_day_1_start_time}}.
...
- Advanced insights in your VIP session
...
| # | Message | Audience | Offset | Send Time (PT) |
|---|---------|----------|--------|----------------|
| 1 | 30 Days Out | All | -29d 23h | 9:00 AM |
| 2 | 25 Days Out | All | -24d 23h | 9:00 AM |
| 3 | 20 Days Out | All | -19d 23h | 9:00 AM |
| 4 | 14 Days Out | All | -13d 23h | 9:00 AM |
| 5 | 10 Days Out | All | -9d 23h | 9:00 AM |
| 6 | 9 Days Out | All | -8d 23h | 9:00 AM |
| 7 | 7 Days Out | All | -6d 23h | 9:00 AM |
| 8 | 5 Days Out | All | -4d 23h | 9:00 AM |
| 9 | 4 Days Out | All | -3d 23h | 9:00 AM |
| 10a | 3 Days Out | Non-VIP | -2d 23h | 9:00 AM |
...
- All SMS use GHL custom values for dates — no hardcoded dates
- Multi-segment messages are acceptable for pre-event (higher engagement)
- No trigger words (URGENT, FREE, LIMITED, etc.)
- Business name included for identification
- VIP variants provide elevated messaging without spoiling content
- Day-of SMS are in 04-day-of-reminders/day-of-sms.md
