...
```
Neothink Society: 3 days until your transformation begins. Block {{custom_values.doe_event_dates}} completely. No distractions. Your golden life is waiting.
```
...
- All SMS use custom values for dates
- No trigger words (URGENT, FREE, etc.)
- Business name included for identification
- Character counts are approximate (varies with custom value length)
