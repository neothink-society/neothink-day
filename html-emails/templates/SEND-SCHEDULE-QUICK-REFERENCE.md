# Email Send Schedule - Quick Reference Guide

**Both Events - Complete Automation Setup**

Use this guide to set up your email automation in GoHighLevel. Copy/paste subject lines and preview text exactly as shown.

---

## 📅 NOVEMBER 2025 Workshop (Nov 22-23, 2025)
...
## 📅 DECEMBER 2025 Workshop (Dec 6-7, 2025)
...
### Timezone Settings
- **CRITICAL**: Set all automations to **Pacific Time (PT)**
- December is PST (Pacific Standard Time) - no DST

### Automation Logic
1. Registration triggers immediate confirmation email
2. VIP purchase triggers immediate VIP confirmation
3. All countdown emails triggered by "days before event" calculation
...
### Testing Checklist
- [ ] All send times set to Pacific Time (PT)
- [ ] Zoom links correct for each event (different links!)
- [ ] Workshop hub URLs correct (neothinkday.com vs neothinkevent.com)
- [ ] Subject lines copied exactly (including emojis)
- [ ] Preview text copied exactly
- [ ] Late registration logic tested
- [ ] Day-of email sends at exactly 7:00 AM PT

---

## 📊 Send Time Strategy

### Early Morning (7am-9am PT)
**Who**: Day 9, Day 7, Day 3, Day 0
**Why**: Action-required emails, top of inbox, full day to complete tasks

### Mid-Morning (9am-11am PT)
**Who**: Day 20, Day 14, Day 4, Day 2
**Why**: Planning emails, people settled into day, read thoroughly

### Evening (6pm PT)
**Who**: Day 1 ONLY
**Why**: Read before bed, set alarms overnight, mental preparation

### Immediate (24/7)
**Who**: Registration, VIP confirmation
**Why**: Instant gratification, confirms transaction immediately
...
**Quick Copy/Paste Ready**: All subject lines and preview text formatted for direct entry into GoHighLevel automation builder.
