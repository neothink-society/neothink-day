# November 2025 - Bridge + Countdown Email Structure

## BRIDGE EMAILS (Non-Countdown, Thu Nov 13 - Sun Nov 16)

### 3. Welcome Email (Bridge #1)
**File**: `welcome-email.html`
**Automation Timing**: Immediately upon registration
...
**Purpose**: Build exclusivity, differentiate from typical workshops
**Key Elements**:
...
**Focus**: Establish exclusivity and anticipation WITHOUT time pressure

---

### 4. Methodology Email (Bridge #2)
**File**: `methodology-email.html`
**Automation Timing**: 24 hours after registration (skip if registered Sun/Mon)
...
**Purpose**: Build authority, address skepticism, explain methodology
**Key Elements**:
...
### 5. Day 5 - Pre-Work Assignment ⭐
**File**: `preparation-5days.html`
**Automation Timing**: Monday, November 17 @ 7:00 AM PT (ALL registrants synced)
...
**Focus**: CRITICAL - Everyone gets this regardless of registration date

---

### 6. Day 4 - Calendar Blocking
**File**: `preparation-4days.html`
**Automation Timing**: Tuesday, November 18 @ 10:00 AM PT
...
### 8. Day 2 - Final Preparation
**File**: `preparation-2days.html`
**Automation Timing**: Thursday, November 20 @ 11:00 AM PT
...
**Automation Timing**: Friday, November 21 @ 6:00 PM PT
...
### 10. Day 0 - Zoom Link
**File**: `day-of.html`
**Automation Timing**: Saturday, November 22 @ 7:00 AM PT SHARP
...
**Phase 1: Bridge Emails (Thu Nov 13 - Sun Nov 16)**
1. **Upon Registration** → Send Registration Confirmation immediately
2. **Upon VIP Purchase** → Send VIP Confirmation immediately
3. **Upon Registration** → Send Welcome Email immediately
4. **24 Hours After Registration** → Send Methodology Email (skip if registered Sun/Mon)

**Phase 2: Countdown Sequence (Mon Nov 17 - Sat Nov 22)**
5. **Monday, Nov 17 @ 7am PT** → Day 5 Pre-Work Email (ALL registrants)
...
**Bridge Phase (Nov 13-16)**:
- 2 emails over 4 days (every ~24 hours)
- Focus: Anticipation building, no urgency

**Countdown Phase (Nov 17-22)**:
- 6 emails over 6 days (daily)
- Focus: Escalating urgency, tactical preparation

### Late Registration Handling

**If someone registers Thu Nov 13 - Sun Nov 16:**
- Get Bridge #1 immediately
- Get Bridge #2 after 24 hours (unless it's Sun/Mon → skip)
- Sync to countdown on Monday Nov 17

**If someone registers Mon Nov 17 or later:**
...
- Bridge emails promote VIP upgrade (soft mentions)
- Day 3 email is the MAIN VIP conversion push (72 hours optimal window)
- Day 2 and Day 1 emails mention VIP upgrade closing soon
