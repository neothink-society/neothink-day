...
## SMS #1: 7:30 AM PT (Doors Open)

**Send Time:** Saturday, November 22 @ 7:30 AM PT
**Purpose:** Doors literally open, first mobile push
...
## SMS #2: 8:00 AM PT (Official Start)

**Send Time:** Saturday, November 22 @ 8:00 AM PT
**Purpose:** Official start time, simultaneous with email
...
Don't miss another second.

- Neothink Society
```

**Character Count:** 153
**Expected:** 98% open rate, 20-30% additional joins (stragglers)
...
### Timing
- ✅ Send at exact times (no delays)
- ✅ Space at least 15 minutes apart
- ✅ Final SMS no later than 8:45 AM (15 min buffer)

### Message Quality
- ✅ Always include Zoom link
- ✅ Keep under 160 characters when possible
- ✅ Use emojis for visual urgency (🔴 ⚡)
- ✅ Always sign "- Neothink Society"

### What NOT to Do
- ❌ Don't send after 8:55 AM (too late, Wallace speaking)
- ❌ Don't send more than 5 SMS total (spam)
- ❌ Don't use ALL CAPS (feels shouty on mobile)
- ❌ Don't forget Zoom link in ANY message
...
**Friday Night (Nov 21):**
- [ ] Load all SMS into sending platform
- [ ] Schedule exact send times (7:30, 8:00, 8:30, 8:45)
- [ ] Test Zoom link is working
- [ ] Verify recipient list is correct

**Saturday Morning (Nov 22):**
- [ ] 7:25 AM: Final check all SMS are queued
- [ ] 7:30 AM: Monitor SMS #1 delivery
- [ ] 8:00 AM: Monitor SMS #2 delivery
- [ ] 8:30 AM: Monitor SMS #3 delivery
- [ ] 8:45 AM: Monitor SMS #4 delivery
- [ ] 9:00 AM: Wallace takes stage (STOP sending)
...
- MessageBird (good international, $0.01/SMS)
- Amazon SNS (cheapest, $0.006/SMS, but harder setup)

**Delivery Speed:**
- All platforms: 2-5 seconds average delivery
- Peak saturation: Up to 30 seconds during high-volume
- Allow 1-minute buffer for full delivery

**Tracking:**
- Enable delivery receipts
- Monitor open/click rates (requires tracking links)
- Watch for carrier blocks (rare with good content)

---

**Status:** Ready for implementation
**Recommendation:** Option B (4 SMS)
**Total Cost:** ~$100-200
**ROI:** Potentially +5-10% attendance = $1,500-3,000 VIP value
