...
async function testThursdayEmails() {
  console.log('Testing updated Thursday emails for mobile responsiveness...\n');
  ...
  if (issues.length === 0) {
    console.log('✅ All updated Thursday emails are mobile responsive!');
  } else {
